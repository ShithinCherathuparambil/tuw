...
import 'package:tuw_services/utils/pdfApi.dart';
import 'package:tuw_services/widgets/custom_drawer.dart';
import '../../l10n/app_localizations.dart';
import 'package:tuw_services/widgets/payment_custom_listTile.dart';

class PaymentSuccessPage extends StatefulWidget {
  final discount;
  const PaymentSuccessPage({Key? key, required this.discount})
      : super(key: key);
                                ...
                                : SizedBox(
                                    ...
                                    child: Stack(
                                      ...
                                      children: [
                                        ...
                                        Image.asset(
                                          'assets/images/payment_success.png', // Use static image instead
                                          height: 200,
                                          width: 200,
                                          fit: BoxFit.contain,
                                        ),
