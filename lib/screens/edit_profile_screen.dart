...
import 'package:tuw_services/widgets/profile_image.dart';
...
class _ProfileDetailsPageState extends State<EditProfileScreen> {
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.fromLTRB(
                                          0, 20, 0, 0),
                                      child:
                                          TitleWidget(name: str.p_first_name),
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.fromLTRB(
                                          0, 10, 0, 0),
  ...
  updateProfile(
    ...
    String? firstName = toBeginningOfSentenceCase(firstname);
  ...
  void s(String filter) {
    ...
    if (filteredCountries.isNotEmpty) {
      countryid = filteredCountries[0].countryId;
